...
##venn
my_genes <- 560  
literature_genes <- 5075  
overlap_genes <- 218  


gene_lists <- list(
  Your_Genes = t1_gene_viral_load_sig$genes,  
  Literature_Genes = unique(host_factors$Gene.name)
)
...
p_value <- phyper(
  q = overlap_genes - 1,  
  m = literature_genes,   
  n = total_genes - literature_genes,  
  k = my_genes,          
  lower.tail = FALSE     
)
